...
import { ArrowRight, ArrowLeft, Info, Download, Sparkles } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex justify-between mb-2 text-xs text-slate-500">
                        <span>Step {currentStep + 1} of {PRO_STEPS.length}</span>
                        <span>{Math.round(progress)}% Complete</span>
                    </div>
                    <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-brand-500 to-amber-500 transition-all duration-300" style={{ width: `${progress}%` }} />
                    </div>
                </div>

                <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-10 backdrop-blur-sm">
