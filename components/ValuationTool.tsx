...
const STEPS = [
    { id: 'company', title: 'Company Info', icon: Activity },
    { id: 'financials', title: 'Financials', icon: DollarSign },
    { id: 'growth', title: 'Growth & Churn', icon: TrendingUp },
    { id: 'risk', title: 'Risk Profile', icon: ShieldCheck },
    { id: 'results', title: 'Valuation', icon: Calculator },
];
        ...
        <section id="valuation-tool" className="py-24 bg-slate-900 border-y border-slate-800 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-8 max-w-2xl mx-auto">
                  ...
                  ${isActive ? 'bg-brand-500 text-white shadow-[0_0_15px_-3px_rgba(20,184,166,0.6)]' :
                                        isCompleted ? 'bg-slate-800 text-brand-400 border border-brand-500/50' : 'bg-slate-950 text-slate-600 border border-slate-800'
                                    }
`}>
                                    <Icon className="w-5 h-5" />
                                </div>
                                <span className={`text-xs font-medium ${isActive ? 'text-brand-400' : 'text-slate-600'} `}>{step.title}</span>
                            </div>
                        );
                    })}
                    {/* Progress Line */}
                    <div className="absolute top-5 left-0 w-full h-0.5 bg-slate-800 -z-0 max-w-2xl mx-auto right-0" />
                    <div
                ...
                {/* Wizard Card */}
                <div className="bg-slate-950/80 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 md:p-12 shadow-2xl min-h-[500px] relative">
